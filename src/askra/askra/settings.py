...
DATABASES = {
    'default': {
        ...
        'NAME': 'askra-temp',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'qz6_igdd#oqb_*5ax4jevi#u29ty(b3lruoa4nw_d!+^mar&amp;=*'
...
ROOT_URLCONF = 'askra.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'askra.wsgi.application'
...
AUTHENTICATION_BACKENDS = (
    # is required for admin login so, don't remove it :P
...
# if False will disable social based expiration and session expiration
# will follow the default expiration (what ever is there for normal django
# user session)

...
def load_facet_detail_map():
    ...
    retVal["higher_education_degree"] = FacetDetails("higher_education_degree", "Higher Education Degree")
    retVal["higher_education_college"] = FacetDetails("higher_education_college", "Higher Education College")
        ...
        for facet_detail in self.facet_detail_map.values():
            if facet_detail.options_selected:
                if facet_to_exclude and facet_detail.facet_id == facet_to_exclude:
                    continue
                temp_sqs = temp_sqs.filter(**{facet_detail.facet_id+"__exact__in": facet_detail.options_selected})
        return temp_sqs        
    ...
    def update_facet_counts(self):
        ...
        for facet_id in self.facet_detail_map.keys():
            ...
            if self.facet_detail_map[facet_id].options_selected:
                ...
                self.facet_detail_map[facet_id].facet_options = temp_sqs.facet_counts()['fields'][facet_id]            

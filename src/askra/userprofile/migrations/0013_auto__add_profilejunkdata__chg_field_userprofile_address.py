...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProfileJunkData'
        db.create_table('userprofile_profilejunkdata', (
        ...
        db.send_create_signal('userprofile', ['ProfileJunkData'])


        # Changing field 'UserProfile.address'
        db.alter_column('userprofile_userprofile', 'address', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):
        # Deleting model 'ProfileJunkData'
        db.delete_table('userprofile_profilejunkdata')


        # Changing field 'UserProfile.address'
        db.alter_column('userprofile_userprofile', 'address', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HigherEducationBranch'
        db.create_table('userprofile_highereducationbranch', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('userprofile', ['HigherEducationBranch'])

        # Adding field 'HigherEducationDetail.branch'
        db.add_column('userprofile_highereducationdetail', 'branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['userprofile.HigherEducationBranch']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'HigherEducationBranch'
        db.delete_table('userprofile_highereducationbranch')

        # Deleting field 'HigherEducationDetail.branch'
        db.delete_column('userprofile_highereducationdetail', 'branch_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Branch.specialisation'
        db.add_column('userprofile_branch', 'specialisation',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.date_of_birth'
        db.add_column('userprofile_userprofile', 'date_of_birth',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'UserProfile.phone_number'
        db.alter_column('userprofile_userprofile', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'Branch.specialisation'
        db.delete_column('userprofile_branch', 'specialisation')

        # Deleting field 'UserProfile.date_of_birth'
        db.delete_column('userprofile_userprofile', 'date_of_birth')


        # Changing field 'UserProfile.phone_number'
        db.alter_column('userprofile_userprofile', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

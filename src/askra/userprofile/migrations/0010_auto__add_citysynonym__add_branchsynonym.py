...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CitySynonym'
        db.create_table('userprofile_citysynonym', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['userprofile.City'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('userprofile', ['CitySynonym'])

        # Adding model 'BranchSynonym'
        db.create_table('userprofile_branchsynonym', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('branch', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['userprofile.Branch'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('userprofile', ['BranchSynonym'])


    def backwards(self, orm):
        # Deleting model 'CitySynonym'
        db.delete_table('userprofile_citysynonym')

        # Deleting model 'BranchSynonym'
        db.delete_table('userprofile_branchsynonym')

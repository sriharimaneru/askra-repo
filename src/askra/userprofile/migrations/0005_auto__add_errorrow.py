...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ErrorRow'
        db.create_table('userprofile_errorrow', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('csv_file', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['userprofile.CsvUpload'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('reason', self.gf('django.db.models.fields.TextField')()),
            ('action', self.gf('django.db.models.fields.IntegerField')(default=2)),
        ))
        db.send_create_signal('userprofile', ['ErrorRow'])


    def backwards(self, orm):
        # Deleting model 'ErrorRow'
        db.delete_table('userprofile_errorrow')

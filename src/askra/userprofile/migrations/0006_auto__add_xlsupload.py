...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'XlsUpload'
        db.create_table('userprofile_xlsupload', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uploaded_file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('userprofile', ['XlsUpload'])


    def backwards(self, orm):
        # Deleting model 'XlsUpload'
        db.delete_table('userprofile_xlsupload')

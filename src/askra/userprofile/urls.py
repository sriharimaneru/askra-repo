...
urlpatterns = patterns('',
                       # Examples:
                       url(r'^view(/?)(?P<profile_id>.*)$',
                           ShowProfileView.as_view(), name='viewprofile'),
                       url(r'^edit(/)(?P<profile_id>.*)$',
                           EditProfileView.as_view(), name='editprofile'),
                       ...
                       url(r'^resourcelist/?$',
                           ResourceListAjaxView.as_view(), name='resourcelist'),
                       )
